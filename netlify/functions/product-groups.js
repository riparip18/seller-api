...
exports.handler = async function handler(event) {
  try {
    ...
    const { category_id, brand_id } = qs;
    if (!category_id || !brand_id) {
      return { statusCode: 400, headers: { 'content-type': 'application/json' }, body: JSON.stringify({ success: false, error: 'Missing required parameters: category_id, brand_id' }) };
    }
